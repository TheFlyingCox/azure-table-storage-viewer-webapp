...
Handlebars.registerHelper('ifTrue', text => text === 'True' ? "background-color: green; color:white;" : text === 'Error' ? "background-color: red; color:white;" : "background-color: inherit;");
